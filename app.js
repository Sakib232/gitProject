...
const mockIssues = [
  ...
  },
  {
    ...
    description: "Application becomes slow when loading more than 1000 records. Need to implement pagination or virtual scrolling.",
    status: "Open",
    priority: "High",
    label: "No Label",
    author: "alex_perf",
...
async function handleSearch() {
  ...
  try {
    ...
    renderIssues(filterIssues(filtered, currentStatus));
  } finally {
    hideLoader();
  }
}
